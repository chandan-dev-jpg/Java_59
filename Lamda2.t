...
public class FunctionalInterface {
	public static void main(String[] args) {
		String str -> str.equals("goolge");
		System.out.println(str);
	}
}

ANS:
Error(A lambda must be assigned to a functional interface, such as Predicate<String>.)
...
ANS:Error(A @FunctionalInterface must have exactly one abstract method.)
...
interface NIT {
    ...
    int hashCode();               // Object method
    String toString();            // Object method
}
ANS:Valid 
...
ANS:Error (This interface is not valid. The problem is with wait() and notify().)
